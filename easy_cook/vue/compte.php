    ...
    <body>
        ...
        <div class="page">
            ...
            while ($donnee = mysql_fetch_assoc($rq)) {
                ...
                echo "<td>";
                ?>
                <a href="../traitement/admin.php?id_utilisateur=<?php echo $donnee['id']; ?>">SUPPRIMER</a>
                <?php
                echo "</td>";
                echo "</tr>";
            ...
            while ($donnee = mysql_fetch_assoc($rqq)) {
                ...
                echo "<td>";
                ?>
                <a href="../traitement/admin.php?id_recette=<?php echo $donnee['id']; ?>">SUPPRIMER</a>
                <?php
                echo "</td>";
                echo "</tr>";
        ...
        <div class="page">
            ...
            echo "Votre email : " . $row['mail'] . "<br><br>";
                ?>
                <table>
                    <form method="post" action="../traitement/update_acc.php">
                        <tr>
